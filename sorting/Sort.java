...
public final class Sort
{
    ...
    public static void main( String [ ] args )
    {
	    ...
	    System.out.println( "Total time used for insertion in array nanos: " + ((end-start)) );
	    ...
	    System.out.println( "Total time used to find kth smallest in nanos: " + ((end-start)) );
	    
        System.out.println("Quickselect:");
//        Sort.print(a);
        System.out.println("10th smallest = " + a[k-1]);
        
        System.out.println("10 smallest ones are= ");
//        10 smallest ones
        for (int i=0; i<10; i++) {
